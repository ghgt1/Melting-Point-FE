import{j as t,d as y,e as k,f as S,h as v,s as c,a as N,u as w,r as x,L as C}from"./index-590e0a99.js";import{N as $}from"./NextBtn-c819b2a1.js";import{C as h,r as g}from"./returnChar-00f6dc21.js";import{h as B,i as E}from"./querykey-87bb2f4e.js";import{u as T}from"./useQuery-7e63b949.js";import{u as _}from"./getMbtiOrder-2e989732.js";import{u as R}from"./getRoomStatus-4c843c97.js";import{u as I}from"./postNextGame-111ee742.js";import{m as L}from"./motion-bc0354a1.js";import"./useMutation-5fab2dc8.js";function O({isLast:s=!1,nickname:r,mbti:e,onClick:l}){return t.jsx(y,{children:t.jsxs(k,{children:[t.jsxs(S,{children:[`${r}님의 MBTI는`,t.jsx("br",{}),`${e}였습니다!`]}),t.jsx(v,{onClick:l,children:s?"다음 게임 할게요!":"다음 팀원 보기"})]})})}const z=async(s,r)=>{try{return(await E.get("/mbti/result",{params:{url:s,round_id:r}})).data}catch(e){throw console.error("요청중 에러가 발생하였습니다:",e),e}},P=(s,r)=>T([B],()=>z(s,r),{onError:e=>{console.error("Query 처리중 에러가 발생하였습니다:",e)}}),W=c.main`
  display: flex;
